...
> **This project has been superseded by [xmpd](https://github.com/tuncenator/xmpd).**
> xmpd is a multi-provider rewrite supporting YouTube Music, Tidal HiFi, and more.
> All development continues there. See [MIGRATION.md](https://github.com/tuncenator/xmpd/blob/main/docs/MIGRATION.md)
